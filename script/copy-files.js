...
async function copyFile(file) {
  ...
  if (ENV === 'production') {
    ...
    buildPath = path.resolve(__dirname, '../demo/node_modules/react-echarts-binding/', path.basename(file));
  }
...
async function createPackageFile() {
  ...
  if (ENV === 'production') {
    ...
    buildPath = path.resolve(__dirname, '../demo/node_modules/react-echarts-binding/package.json');
  }
